        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="mt-6 bg-gradient-to-r from-orange-500 to-orange-600 p-4 rounded-lg">
                <h4 className="font-medium text-white mb-2">Download Our App</h4>
                <div className="flex gap-2">
                  <a href="#" className="bg-black text-white rounded-md px-3 py-2 text-xs flex items-center space-x-1 hover:bg-gray-900">
